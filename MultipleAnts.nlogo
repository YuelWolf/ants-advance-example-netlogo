...
to go
  ...
  [
    if lost-pheromone? < probability-to-evaporate
    [set pheromone pheromone - 1]
    set plabel pheromone
    if pcolor != orange and pcolor != green
    [
     if pheromone = 0 [set pcolor black]
     if pheromone = 1 [set pcolor 98]
     if pheromone = 2 [set pcolor 107]
     if pheromone > 2 [set pcolor 116]
    ]
  ]
  tick
end

to-report lost-pheromone?
